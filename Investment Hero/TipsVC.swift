...
class TipsVC: UIViewController {
    ...
    @IBOutlet weak var newTipLbl : UILabel!
    ...
    override func viewDidLoad() {
        ...
        newTipLbl.text = tips?[randomIndex]
    }
    ...
    @IBOutlet weak var resetDB: UIButton!
    @IBAction func resetDBbtnPressed(_ sender: Any) {
        DataService.shared.REF_ORDERS.removeValue()
        DataService.shared.recreateDefaultOrders()
    }
